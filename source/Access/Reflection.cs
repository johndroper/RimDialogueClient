...
namespace RimDialogue.Access
{
  ...
  {
    public static readonly MethodInfo Verse_PlayLogEntry_Interaction_GenerateGrammarRequest = AccessTools.Method(typeof(PlayLogEntry_Interaction), "GenerateGrammarRequest");
    public static readonly FieldInfo Verse_PlayLogEntry_Interaction_extraSentencePacks = AccessTools.Field(typeof(PlayLogEntry_Interaction), "extraSentencePacks");
